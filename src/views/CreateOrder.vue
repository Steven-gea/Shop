<template>
    <div class="container">
                ...
                <table class="table mt-4">
                    ...
                    <tbody>
                        ...
                        <tr v-for="(item, key) in cart.carts" :key="key">
                            ...
                            <td class="align-middle text-right">
                                {{ $filters.currencyUSD(item.final_total) }}
                            </td>
                        </tr>
                    </tbody>
                    <tfoot v-if="!cartEmpty">
                        <tr>
                            ...
                            <td class="text-right">
                                {{ $filters.currencyUSD(cart.total) }}
                            </td>
                        </tr>
                        <tr v-if="cart.final_total !== cart.total">
                            ...
                            <td class="text-right text-success">
                                {{ $filters.currencyUSD(cart.final_total) }}
                            </td>
                        </tr>
                        <tr>
                            <td
        ...
        <div class="row justify-content-center my-4">
            <div
                class="col-md-6 order-md-2 u-orderbtn-step"
                v-if="cart.total !== 0"
            >
                <button
                    type="button"
                    class="btn btn-info d-block mr-2"
                    v-if="step == 2"
            ...
            <div
                :class="{ 'col-md-4': cart.total !== 0 }"
                class="order-md-1 u-orderbtn-shop"
            >
                <router-link
                    class="nav-item btn btn-outline-info d-inline-block"
                    to="/"
                >
                    &lt;&lt; 我要繼續逛</router-link
                >
