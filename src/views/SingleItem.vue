            ...
            <ol class="breadcrumb">
                <div class="container d-flex">
                    <li class="breadcrumb-item">
                        <router-link to="/">Weird Store</router-link>
                    </li>
            ...
            <div class="row justify-content-center my-4">
                ...
                <div class="col-md-5 order-md-1 mt-4 mt-md-0">
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <del v-if="product.price" class="mr-2"
                            >原價{{
                                $filters.currencyUSD(product.origin_price)
                            }}</del
                        >
                        <div class="h5 text-danger" v-if="product.price">
                            特價{{ $filters.currencyUSD(product.price) }}
                        </div>
                    </div>
                    <hr />
                    <div class="d-flex justify-content-around mx-4">
                        <div class="u-pointer">
                            <i class="far fa-thumbs-up"></i>評價
                        </div>
                        <div class="u-pointer">
                            <i class="fas fa-pencil-ruler"></i>尺寸
                        </div>
                        <div class="u-pointer">
                    ...
                    <div class="d-flex my-4">
                        ...
                        <button
                            class="btn btn-primary u-pointer"
                ...
                <div class="col-10">
                    ...
                    <div class="u-desc text-center">
                        ...
                        <p>
                            ...
                            elit. Nobis repellendus, facilis, culpa itaque atque
                            excepturi quia, explicabo officiis odio enim
                            provident ipsam id dolor eligendi similique minima
                            dicta nihil voluptate.
                        </p>
                    </div>
                    <!-- image -->
                    <div
                        class="text-center mb-2"
                        v-for="(url, key) in randomUrl"
                        :key="key"
                    >
                        <img
                            :src="url"
                    ...
                    <div class="text-center">
                        <router-link class="btn btn-info text-white" to="/faq"
                            >購物指南</router-link
                        >
                    </div>
    ...
    data() {
        ...
        return {
            ...
            product: {
                ...
                origin_price: route.params.price * 1.5,
                imageUrl: route.params.img,
