<template>
    <div class="wrapper">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <router-link class="nav-item nav-link store-name" to="/"
                >Shop</router-link
            >
            <button
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ml-4">
                    <div @click="hideMenu()">
                        <router-link class="nav-item nav-link mr-2" to="/"
                            >Home</router-link
                        >
                    </div>
                    <div @click="hideMenu()">
                        <router-link class="nav-item nav-link mr-2" to="/faq"
                            >FAQ</router-link
                        >
                    </div>
                    <div @click="hideMenu()">
                        <a
                            href="https://steven-gea.github.io/Blog/"
        ...
        <div class="cart-sm">
            ...
            <div class="cart-box" v-if="isShow">
                <div
                    class="row justify-content-center bg-light border rounded py-3"
                >
                    <div class="col-md-12">
                            ...
                            <tbody>
                                ...
                                >
                                    <td>
                                        <button
                                            type="button"
                                            class="btn bg-transparent btn-sm d-none d-md-block"
                                            @click="removeCart(item.id)"
                                        >
                                            <i class="far fa-trash-alt"></i>
                                        </button>
                                    </td>
                                    <td class="text-info u-cart-title">
                                        {{ item.product.title }}
                                    </td>
                                    <td>
                        ...
                        >
                            <button
                                type="button"
                                class="btn btn-danger d-block mx-auto w-100"
                                @click="isShow = !isShow"
                            >
                                結帳去
                            </button>
                        ...
                        <button
                            type="button"
                            class="btn btn-danger d-block text-white mx-auto w-100 mt-2"
                            v-if="cart.carts.length == 0"
                            @click="isShow = !isShow"
                        >
                            繼續購物
