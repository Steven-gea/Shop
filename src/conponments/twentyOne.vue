<template>
    <div class="col-md-4 mb-4" v-for="(item, index) in twentyOne" :key="index">
        <!--@click="carClick()"
...
export default {
    ...
    // mounted() {
    //     axios.get("http://localhost:1000/21").then((res) => {
    //         // http://localhost:3000/filtData?category=21
    //         this.twentyOne = res.data;
    //     });
    // },
};
</script>
